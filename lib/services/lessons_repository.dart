...
abstract class LessonsRepository extends StudentApiService{
  LessonsRepository({required super.studentId, required super.token, required super.apiUrl});
...
class AppLessonsRepository extends LessonsRepository{
  ...
  AppLessonsRepository({required super.studentId, required super.token, required super.apiUrl}){
